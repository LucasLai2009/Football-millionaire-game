    ...
    return (
        <div className="flex flex-col items-center justify-center p-4 sm:p-8 z-10 animate-fade-in w-full max-w-3xl text-center">
            ...
            <div className="mt-8 text-xs text-slate-600 max-w-xl mx-auto space-y-2">
                ...
                <p>
                    All player names, team names, and brands are property of their respective owners. The use of these trademarks is for identification and informational purposes only and does not imply endorsement or affiliation.
                </p>
                <p className="italic text-slate-500">
                    This game is actively updated with new content and features. As the world of football is always changing, some facts may become outdated. We strive for accuracy and appreciate your understanding.
                </p>
