...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStartGame, onGoToShop, onGoToCollection, onGoToDuplicates, onGoToModes, onOpenResetConfirm }) => {
    return (
        <div className="flex flex-col items-center justify-center p-4 sm:p-8 z-10 animate-fade-in w-full max-w-3xl text-center">
            ...
            <div className="absolute bottom-4 right-4 sm:relative sm:bottom-auto sm:right-auto sm:mt-4">
                <button
                    onClick={onOpenResetConfirm}
                    className="flex items-center gap-2 text-sm text-slate-500 hover:text-red-500 transition-colors mx-auto"
