...
const PACKS: PackDefinition[] = [
    { name: 'Bronze Pack', cost: 50000, description: '3 cards. Mostly common, with a small chance for better.', contents: { total: 3, guaranteed: null }, color: 'from-orange-900 to-orange-700', rarity: 'Bronze'},
    { name: 'Silver Pack', cost: 200000, description: '5 cards. Increased chance for Rare cards.', contents: { total: 5, guaranteed: null }, color: 'from-slate-600 to-slate-500', rarity: 'Silver' },
    { name: 'Gold Pack', cost: 500000, description: '7 cards, with at least one guaranteed Rare or better.', contents: { total: 7, guaranteed: { rarity: 'Rare', count: 1 } }, color: 'from-amber-500 to-amber-400', rarity: 'Rare' },
    { name: 'Platinum Pack', cost: 1000000, description: '8 cards, including at least two Rare cards or better.', contents: { total: 8, guaranteed: { rarity: 'Rare', count: 2 } }, color: 'from-purple-700 to-purple-500', rarity: 'Epic' },
    { name: 'Ultimate Pack', cost: 10000000, description: '10 cards, all guaranteed to be Rare or better!', contents: { total: 10, guaranteed: { rarity: 'Rare', count: 10 } }, color: 'from-sky-700 to-sky-500', rarity: 'Legendary' },
];
